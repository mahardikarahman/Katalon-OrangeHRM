...
WebUI.setText(findTestObject('Object Repository/Page_OrangeHRM/input'), 'jono')
...
WebUI.setText(findTestObject('Object Repository/Page_OrangeHRM/input'), 'alice')

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/button_Search'))

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/div_0221Alice DuvalAccount AssistantFull-Ti_4e9108'))
